...
export function sociosPorCPF(request, response) {

    let cpf = request.params.cpf;
    const body_impala = readFileSync("./routes/socios/cpf/body_impala.json");
    ...
    fetch("https://boavista-dados.ciasc.sc.gov.br/notebook/api/execute/impala", {
      ...
      .then((data) => {
        ...
        const body_fetch = readFileSync("./routes/socios/cpf/body_fetch.json");
