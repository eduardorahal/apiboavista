...
export function sociosPorCNPJ(request, response) {

    let cnpj = request.params.cnpj;
    const body_impala = readFileSync("./routes/socios/cnpj/body_impala.json");
    ...
    fetch("https://boavista-dados.ciasc.sc.gov.br/notebook/api/execute/impala", {
      ...
      .then((data) => {
        ...
        const body_fetch = readFileSync("./routes/socios/cnpj/body_fetch.json");
