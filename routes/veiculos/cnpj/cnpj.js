...
export function veiculosPorCNPJ(request, response) {

    let cnpj = request.params.cnpj;
    const body_impala = readFileSync("./routes/veiculos/cnpj/body_impala.json");
    ...
    fetch("https://boavista-dados.ciasc.sc.gov.br/notebook/api/execute/impala", {
      ...
      .then((data) => {
        ...
        const body_fetch = readFileSync("./routes/veiculos/cnpj/body_fetch.json");
