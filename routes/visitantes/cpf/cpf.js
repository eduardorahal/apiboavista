...
export function visitantesPorCPF(request, response) {

    let cpf = request.params.cpf;
    const body_impala = readFileSync("./routes/visitantes/cpf/body_impala.json");
    ...
    fetch("https://boavista-dados.ciasc.sc.gov.br/notebook/api/execute/impala", {
      ...
      .then((data) => {
        ...
        const body_fetch = readFileSync("./routes/visitantes/cpf/body_fetch.json");
