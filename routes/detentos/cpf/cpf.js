...
export function detentosPorCPF(request, response) {

    let cpf = request.params.cpf;
    const body_impala = readFileSync("./routes/detentos/cpf/body_impala.json");
    ...
    fetch("https://boavista-dados.ciasc.sc.gov.br/notebook/api/execute/impala", {
      ...
      .then((data) => {
        ...
        const body_fetch = readFileSync("./routes/detentos/cpf/body_fetch.json");
