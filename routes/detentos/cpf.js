...
export async function detentos(request, response) {
    await get_login;
    let cpf = request.params.cpf;
    const body_impala = readFileSync("./routes/detentos/body_impala.json");
    ...
    fetch("https://boavista-dados.ciasc.sc.gov.br/notebook/api/execute/impala", {
      ...
      .then((data) => {
        ...
        const body_fetch = readFileSync("./routes/detentos/body_fetch.json");
